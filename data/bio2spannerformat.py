...
if __name__ == '__main__':
	...
	suffixs = ['train', 'dev', 'test', 'unlabel']
	...
	if dataname =='ontonote5':
		...
		column_no =1
		delimiter = '\t'
	elif 'wikiann' in dataname or 'conll03' in dataname:
		delimiter = '\t'

	# convsert conll-2003 to spanner format
	lang = sys.argv[1]
	fpath_bio1 = './{}_'.format(dataname) + str(lang) + "/"
	dump_path = './{}_'.format(dataname) + str(lang) + "/"
	# fpath_bio1 = '../data/genpseudo_es_bio'
	# dump_path = "../data/genpseudo_es/"
