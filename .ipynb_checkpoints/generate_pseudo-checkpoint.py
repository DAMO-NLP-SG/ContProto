...
class BertNerTagger(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        real_predicts = [p[m == 1].tolist() for p, m in zip(predicts, real_span_mask_ltoken)]
        output["predicts"] = real_predicts
    ...
    def validation_epoch_end(self, outputs):
        ...
        ############################################
            ...
            all_predicts = [y for x in outputs for y in x['predicts']] # list (len=num_unlabel) of lists (len=num_span) of lists (len=num_classes)
            ...
            file_prob1 = self.args.default_root_dir + '/' + self.args.modelName + '_prob_dev_ep{:02d}.pkl'.format(self.current_epoch)
            ...
            pickle.dump(all_predicts, fwrite_prob)
